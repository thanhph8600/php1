...
if (isset($_POST['deleteCategory']) && $_POST['deleteCategory']) {
  $slug = $_POST['slug'];
  $sqldelete = 'DELETE FROM `category` WHERE `category`.`slug` = "' . $slug . '"';
  execute($sqldelete);
          ...
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <div class="add"><a class="input_Addproduct" href="./addcategory.php">Add category</a></div>
                <table style="width: 90%;margin:auto" class="table align-items-center mb-0">
                  <thead>
                    <tr class="fs-22">
                      <th class="fs-22 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Category</th>
                      <th class="fs-22 text-secondary text-secondary text-xxs font-weight-bolder opacity-7">Date added</th>
                      <th class="fs-22 text-secondary text-secondary text-xxs font-weight-bolder opacity-7">update date</th>
                  ...
                  <tbody>
                    ...
                    if (isset($category) && $category) {
                      ...
                      foreach ($category as $value) {
                        ...
                        <tr>
                          <td>
                            <span class="namecategory badge badge-sm bg-gradient-secondary">' . $value['name'] . '</span>
                          </td>
                          <td>
                            <span class="">' . $value['created_add'] . '</span>
                          </td>
                          <td>
                            <span class="">' . $value['created_update'] . '</span>
                          </td>
                          <td class="align-middle">
                            <form action="./addcategory.php" method="get">

                              <input type="hidden" name="slug" value="' . $value['name'] . '">
                              <i class="fa fa-wrench edit" aria-hidden="true"></i>

                              <input name="editCategory" type="submit" value="Edit" class="text-xs edit">

                            </form>
                          </td>
                          <td class="align-middle">
                            <form action="" method="post" onsubmit="return deletecategory()">
                              <i class="fa fa-trash delete" aria-hidden="true"></i>
                              <input type="hidden" name="slug" value="' . $value['slug'] . '">
                              <input name="deleteCategory" type="submit" value="Delete" class="text-xs delete">
                            </form>
                          </td>
                        </tr>';
                      }
