...
// $sql = "SELECT `category`.`name` AS `category`,`products`.`id`, `products`.`name`, `category_id`, `price`, `sale`, `content`, `thumb`, `products`.`created-at`, `products`.`updated-at`, `active` FROM `products` JOIN `category` ON `products`.`category_id` = `category`.`id`";
// $products = executeResult($sql);

if (isset($_POST['deleteProduct']) && $_POST['deleteProduct']) {
  $id = $_POST['slug'];
  echo $id;
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <form action="./addproduct.php" method="post" style="display:flex;justify-content:flex-end;width:95%">
                  <input name="next" type="submit" value="Add product" class="input_Addproduct">
                </form>
                <table class="table align-items-center mb-0" style="width:99%;margin:auto">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ten san pham</th>

                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">don gia</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">loại sp</th>
                      ...
                      echo '
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div>
                              <img src="./thumb/' . $item['thumb'] . '" class="avatar avatar-xxl me-3 border-radius-lg" alt="user2">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="name">' . $item['name'] . '</h6>
                              <p class="text-xs text-secondary mb-0"><span>' . $item['created-at'] . '</span><br><span>' . $item['updated-at'] . '</span></p>
                            </div>
                          </div>
                        </td>

                        <td>
                          <p class="text-xs font-weight-bold mb-0">' . $item['sale'] . '<span>đ</span></p>
                        </td>

                        <td class="align-middle text-center text-sm">
                          <span class="badge badge-sm bg-gradient-secondary">' . $item['category'] . '</span>
                        </td>
                        <td>
                        <p class="text-xs font-weight-bold mb-0" style="' ?><?php echo ($item["active"] == 1) ? "color:green" : ""; ?><?php echo '">'; ?>

                    <?php echo ($item["active"] == 1) ? "Kích hoạt" : "chưa kích hoạt"; ?>
                  ...
                  <?php echo '
                        ...
                        <td class="align-middle">
                          <form action="./addproduct.php" method="get">
                            ...
                            <input name="editProduct" type="submit" value="Edit" class="text-xs edit">
          ...
          <div class="spagination">
            ...
            if ($current_page > 1 && $total_page > 1) {
              echo '<a href="product.php?page=' . ($current_page - 1) . '"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a> | ';
            }
            ...
            if ($current_page < $total_page && $total_page > 1) {
              echo '<a href="product.php?page=' . ($current_page + 1) . '"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a>  ';
            }
            ?>
          </div>
        </div>
