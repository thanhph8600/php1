...
if(isset($_POST['deleteBanner']) && $_POST['deleteBanner']){
    $id = $_POST['id'];
    $thumb = $_POST['thumb'];
    
    // xoa anh trong file
    $imgpath = './uploads/' . $thumb;
    unlink($imgpath);
    ...
    .imgbanner img {
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="../banner/banner.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                                <form action="./addbanner.php" method="post" style="display:flex;justify-content:flex-end;width:95%">
                                    <input name="next" type="submit" value="Add banner" class="input_Addproduct">
                                </form>
                                <table class="table align-items-center mb-0" style="width:99%;margin:auto">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Slogan</th>
                                        ...
                                        <?php
                                            ...
                                            foreach($banner as $item){
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="imgbanner">
                                                        <img src="./uploads/'.$item['thumb'].'" />
                                                        </div>
                                                    </td>
                                                    <td>
    
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="name">'.$item['slogan'].'</h6>
                                                            <p class="text-xs text-secondary mb-0"><span>'.$item['created_at'].'</span><br><span></span></p>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="align-middle">
                                                        <form action="./addbanner.php?id='.$item['id'].'" method="get">
                                                            <i class="fa fa-wrench edit" aria-hidden="true"></i>
                                                            <input type="hidden" name="id" value="'.$item['id'].'">
                                                            <input name="editbanner" type="submit" value="Edit" class="text-xs edit">
                                                    ...
                                                    <td class="align-middle">
                                                        <form action="" method="post" onsubmit="return deleteproduct()">
                                                            ...
                                                            <input name="deleteBanner" type="submit" value="Delete" class="text-xs delete">
                                                        </form>
                                                    </td>
                                                </tr>
