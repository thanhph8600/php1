...
$sql = "SELECT SUM(totail)sum FROM oder";
$sum = executeResult($sql);
    ...
    <div class="container-fluid py-4">
            ...
            <div class="col-xl-7 mb-xl-0 mb-4">
              <div class="card bg-transparent shadow-xl">
                <div class="overflow-hidden position-relative border-radius-xl">
                  <img src="../../public/admin/assets/img/illustrations/pattern-tree.svg" class="position-absolute opacity-2 start-0 top-0 w-100 z-index-1 h-100" alt="pattern-tree">
                    ...
                    <div class="d-flex">
                      <div class="d-flex">
                        <div class="me-4">
                          ...
                          <h6 class="text-white mb-0">PHAN HUNG THANH</h6>
                        </div>
                        <div>
                      ...
                      <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                        <img class="w-60 mt-2" src="../../public/admin/assets/img/logos/mastercard.png" alt="logo">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-md-0 mb-4">
                      <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        <img class="w-10 me-3 mb-0" src="../../public/admin/assets/img/logos/mastercard.png" alt="logo">
                    ...
                    <div class="col-md-6">
                      <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        <img class="w-10 me-3 mb-0" src="../../public/admin/assets/img/logos/visa.png" alt="logo">
      ...
      <div class="row">
        <div class="col-md-7 mt-4">
          <div class="card">
            <div class="d-flex card-header pb-0 px-3">
              <div class="col-6 ">
                <h6 class="">Oder </h6>
              </div>
                ...
                foreach ($oder as $item) {
                  ...
                  echo '
                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                          <div class="d-flex flex-column">
                            <h6 class="mb-3 text-sm"><span class="mb-2 text-xs">Code: </span>' . $item['code'] . '</h6>
                            <span class="mb-2 text-xs">Name: <span class="text-dark font-weight-bold ms-sm-2">' . $item['name'] . '</span></span>
                            <span class="mb-2 text-xs">Email Address: <span class="text-dark ms-sm-2 font-weight-bold">' . $item['email'] . '</span></span>
                            <span class="text-xs">Totail: <span class="text-dark ms-sm-2 font-weight-bold">' . $item['totail'] . ' đ</span></span>
                            <span class="text-xs">Order status: <span class="text-dark ms-sm-2 font-weight-bold">' . $status . '</span></span>
                          </div>
                          <div class="ms-auto text-end">

                            <a class="btn btn-link text-dark px-3 mb-0" href="editoder.php?id=' . $item['id'] . '"><i class="fa fa-eye" aria-hidden="true"> </i> Detail</a>
                          </div>
                        </li>
                        ';
                }
            ...
            <div class="card-body pt-4 p-3">
              ...
              <ul class="list-group">
                ...
                foreach ($comment as $item) {
                  echo '
                  <a href="http://localhost:8080/labPHP1/ass/backend/detail.php?id=' . $item['id_product'] . '">
                    <li class="item-comment bg-gray-100 list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                      <div class="d-flex align-items-center">
                        <div class="d-flex flex-column">
                          <h6 class="mb-1 text-dark text-sm">' . $item['name'] . '</h6>
                      <span class="text-xs text-comment">' . $item['message'] . '</span>
                      ...
                      <div class="d-flex flex-column text-end">
                        ...
                        <p class=" text-sm font-weight-bold">ID product : ' . $item['id_product'] . '</p>
                      </div>
                    </li>
                  </a>
