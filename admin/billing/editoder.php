...
if(isset($_POST['xacNhan']) && $_POST['xacNhan']){
    $active = $_POST['active'];
    if($oder[0]['active'] < $active){
        if($oder[0]['active']!=3){
          $sql ="UPDATE `oder` SET `active` = '".$active."' WHERE `oder`.`id` = '".$_GET['id']."'";
          execute($sql);
          header('location: editoder.php?id='.$_GET['id'].'');
        }
                ...
                <?php
                    $status = false;
                        ...
                        <div class="d-flex flex-column">
                          <h6 class="mb-3 text-sm"><span class="">Code: </span>'.$oder[0]['code'].'</h6>
                          <span class="mb-2 ">Name: <span class="text-dark font-weight-bold ms-sm-2">'.$oder[0]['name'].'</span></span>
                          <span class="mb-2 ">Phone: <span class="text-dark font-weight-bold ms-sm-2">'.$oder[0]['phone'].'</span></span>
                          <span class="mb-2 ">Email Address: <span class="text-dark ms-sm-2 font-weight-bold">'.$oder[0]['email'].'</span></span>
                          <span class="mb-2 ">Address: <span class="text-dark ms-sm-2 font-weight-bold">'.$oder[0]['address'].'</span></span>
                          <span class="mb-2 ">Date created: <span class="text-dark ms-sm-2 font-weight-bold">'.$oder[0]['created_at'].'</span></span>
                          <span class="">Totail: <span class="text-dark ms-sm-2 font-weight-bold">'.$oder[0]['totail'].' đ</span></span>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                        ...
                        <form action="" method="post">
                            ...
                            <input <?=($oder[0]['active']==3 || $oder[0]['active']==2 || $oder[0]['active']==1)?'style="background:green;color:#fff;"':''?>  class="btn-xacnhan btn d-flex align-items-center justify-content-center" name="xacNhan" type="submit" value="xác nhận">
                        </form>
                  </div>
                </li>
              </ul>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                        <form action="" method="post">
                            ...
                            <input <?=($oder[0]['active']==3 || $oder[0]['active']==2)?'style="background:green;color:#fff;"':''?> class="btn-xacnhan btn  d-flex align-items-center justify-content-center" name="xacNhan" type="submit" value="xác nhận đã gửi">
                        </form>
                  </div>
                </li>
              </ul>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                        <form action="" method="post">
                            ...
                            <input <?=($oder[0]['active']==3)?'style="background:green;color:#fff;"':''?> class="btn btn-xacnhan d-flex align-items-center justify-content-center" name="xacNhan" type="submit" value="xác nhận đã gửi thành công">
                        </form>
                  </div>
                </li>
              </ul>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                        <form action="" method="post">
                            ...
                            <input <?=($oder[0]['active']==4)?'style="background:black;color:#fff;"':''?> class="btn btn-xacnhanhuy d-flex align-items-center justify-content-center" name="xacNhan" type="submit" value="Hủy đơn">
                        </form>
                  </div>
                </li>
              </ul>
